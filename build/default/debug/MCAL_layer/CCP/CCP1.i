...
# 1 "MCAL_layer/CCP/../Interrupt/mcal_external_Interrupt.h" 1
# 72 "MCAL_layer/CCP/../Interrupt/mcal_external_Interrupt.h"
typedef enum
{
    EXT_INT0,
    EXT_INT1,
...
# 15 "MCAL_layer/CCP/CCP1.h" 2
# 69 "MCAL_layer/CCP/CCP1.h"
typedef enum
{
...
Std_ReturnType CCP_Init(const CCP_t *ccp_obj)
{
    ...
    else
    {
        ...
        else if(ccp_obj->cpp_mode == CCP_PWM_MODE_SELECT)
        {
            ...
            if(ccp_obj->ccp_spacific_mode == (uint8)12)
            {
                if(ccp_obj->ccp_inst == CCP1_inst)
                {
                ...
                PR2 = (uint8)(((float)4000000UL / ((float)ccp_obj->PWM_Freq * 4.0 * (float)ccp_obj->Timer2_Prescaler_value *
